...
extern const struct s2n_blob s2n_tls13_label_derived;
extern const struct s2n_blob s2n_tls13_label_key;
extern const struct s2n_blob s2n_tls13_label_iv;

extern const struct s2n_blob s2n_tls13_label_client_early_traffic;
extern const struct s2n_blob s2n_tls13_label_early_exporter_master_secret;

extern const struct s2n_blob s2n_tls13_label_client_handshake_traffic;
extern const struct s2n_blob s2n_tls13_label_server_handshake_traffic;

extern const struct s2n_blob s2n_tls13_label_client_application_traffic;
extern const struct s2n_blob s2n_tls13_label_server_application_traffic;
